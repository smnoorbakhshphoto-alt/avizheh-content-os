 ...
 * Usage: node database/seed.js "نام کامل" username password
 */
...
async function seed() {
  ...
  if (!fullName || !username || !password) {
    console.error('Usage: node database/seed.js "نام کامل" username password');
    process.exitCode = 1;
    return;
  }
  ...
  try {
    ...
    const { rows } = await pool.query(
      `INSERT INTO team_members (full_name, username, password_hash)
       VALUES ($1, $2, $3)
